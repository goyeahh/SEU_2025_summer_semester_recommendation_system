...
# IMDB - 250部，4个不同分类
# D:\Anaconda_envs\envs\Recommendation_System\python.exe main.py --platform imdb --max-movies 25 --categories top250 popular most_popular_movies top_rated_movies